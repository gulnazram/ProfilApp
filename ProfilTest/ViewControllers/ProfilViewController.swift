...
class ProfilViewController: UIViewController {
    ...
    let identifire = "PhotoCollectionViewCell1"
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(UINib(nibName: "PhotoCollectionViewCell1", bundle: nil), forCellWithReuseIdentifier: identifire)
